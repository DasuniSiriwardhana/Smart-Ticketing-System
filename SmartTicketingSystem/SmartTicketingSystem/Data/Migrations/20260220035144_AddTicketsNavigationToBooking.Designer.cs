...
namespace SmartTicketingSystem.Data.Migrations
{
    ...
    [Migration("20260220035144_AddTicketsNavigationToBooking")]
    partial class AddTicketsNavigationToBooking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartTicketingSystem.Models.BOOKING", b =>
                {
                    b.HasOne("SmartTicketingSystem.Models.EVENT", "Event")
                        .WithMany()
                        .HasForeignKey("EventID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SmartTicketingSystem.Models.USER", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartTicketingSystem.Models.BOOKING_ITEM", b =>
                {
                    b.HasOne("SmartTicketingSystem.Models.BOOKING", "Booking")
                        .WithMany("BookingItems")
                        .HasForeignKey("BookingID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SmartTicketingSystem.Models.TICKET_TYPE", "TicketType")
                        .WithMany("BookingItems")
            ...
            modelBuilder.Entity("SmartTicketingSystem.Models.BOOKING_PROMO", b =>
                {
                    b.HasOne("SmartTicketingSystem.Models.PROMO_CODE", "PromoCode")
                        .WithMany("BookingPromos")
                        .HasForeignKey("BookingCodeID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SmartTicketingSystem.Models.BOOKING", "Booking")
                        .WithOne("BookingPromo")
                        .HasForeignKey("SmartTicketingSystem.Models.BOOKING_PROMO", "BookingID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SmartTicketingSystem.Models.TICKET", b =>
                {
                    ...
                    b.HasOne("SmartTicketingSystem.Models.BOOKING", null)
                        .WithMany("Tickets")
